...
$sql = "SELECT * FROM `rs_super_task` WHERE `date` >= '$date2query'";
...
$result = $db_handle->query($sql);
if($result == false ) {
	echo "<h2> Task creation is not successful, record: $query_id is not enterted in the Database <br> </h2>";
}
else echo "<h2> Task creation is successful, record: $query_id is entered  and assigned to $user. <br> </h2>";
